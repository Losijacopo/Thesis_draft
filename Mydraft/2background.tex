...
\begin{figure}[t]
	\begin{center}
		{\includegraphics[width=.8\textwidth, height=7cm, keepaspectratio]{images/triangulation}}
...
\begin{figure}[t]
	\begin{center}
		{\includegraphics[width=.8\textwidth, height=7cm, keepaspectratio]{images/epipolar-geometry-2}}
