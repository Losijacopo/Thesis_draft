...
The matching cost is evaluated considering each one of the pixel in the left image and the corresponding point in the right image. 
Actually, the whole implementation of this part exploit two different algorithms, the Center-Symmetric Census Transform \citep{Spangenberg2013} and the evaluation of the Hamming Distance between correspondent pixels. 
